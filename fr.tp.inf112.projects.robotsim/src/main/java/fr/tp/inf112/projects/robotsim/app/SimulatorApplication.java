...
import fr.tp.inf112.projects.robotsim.persistance.RemoteFactoryPersistanceManager;
import fr.tp.inf112.projects.robotsim.persistance.RemoteFileCanvasChooser;
...
public class SimulatorApplication {
	...
	public static void main(String[] args) {
		...
		//System.out.println("With parameters " + Arrays.to String(args) + ".");
